...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="text-sm lg:text-base flex flex-col md:flex-row items-center justify-between gap-y-4 md:gap-y-0">
      <div className="flex flex-col w-full md:w-auto justify-between sm:flex-row items-center gap-y-4 md:gap-y-0 space-x-0 md:space-x-3">
      ...
      <div className="flex flex-col sm:flex-row items-center w-full justify-between md:w-auto sm:items-end md:items-center gap-y-4 md:gap-y-0 space-x-0 md:space-x-6">
