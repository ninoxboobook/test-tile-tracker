...
const filterConfig: FilterableColumnConfig<'clayBody' | 'collections' | 'cone' | 'atmosphere'> = {
  columns: ['clayBody', 'collections', 'cone', 'atmosphere'] as const,
  getLabel: (columnId) => {
    switch (columnId) {
      case 'clayBody':
        return 'Clay Body'
  ...
  if (testTiles.length === 0) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-sm text-gray-500 mb-4">Create a test tile using this decoration to start exploring its properties.</p>
