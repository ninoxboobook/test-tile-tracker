    ...
    <div className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex items-center gap-x-12">
          <Link href="/" className="-m-1.5 p-1.5 text-2xl font-semibold text-clay-900">
            Test Tile Tracker
          </Link>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            <div className="mt-24 sm:mt-32 lg:mt-16">
              <a href="#" className="inline-flex space-x-6">
                ...
                <span className="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-clay-600">
                  <span>Just shipped v1.0</span>
                  <ChevronRightIcon className="h-5 w-5 text-clay-400" aria-hidden="true" />
                </span>
              </a>
            </div>
            <h1 className="mt-10 text-4xl font-bold tracking-tight text-clay-900 sm:text-6xl">
              Test Tile Tracker for Potters
            </h1>
            <p className="mt-6 text-lg leading-8 text-clay-600">
              ...
              {session ? (
                <>
                  ...
                  <Link
                    ...
                    className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-clay-600 shadow-sm ring-1 ring-inset ring-clay-600 hover:bg-clay-50"
                  >
                ...
                <>
                  ...
                  <Link
                    href="/login"
                    className="text-sm font-semibold leading-6 text-clay-900"
                  >
          ...
          <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
            <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
              <div className="-m-2 rounded-xl bg-clay-900/5 p-2 ring-1 ring-inset ring-clay-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <Image
                  ...
                  width={2432}
                  height={1442}
                  className="w-[76rem] rounded-md shadow-2xl ring-1 ring-clay-900/10"
                />
              </div>
            </div>
          </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-clay-900 sm:text-4xl">
