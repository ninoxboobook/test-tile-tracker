...
Test Tile Tracker is built and maintained by Rihana Ries.
...
### The Test Tile Tracker process {#the-test-tile-tracker-process}

#### Basic {#basic}
1. First, create clay body entries:
   - Add basic details (name, type)
   - Specify firing requirements
...
3. Create test tiles:
   - Select the clay body used
   - Add decoration layers in order
   - Specify firing details
...
### Clay bodies: your foundation library {#clay-bodies}
...
### Decorations: building your surface treatment library {#decorations}
...
### Test tiles: bringing it all together {#test-tiles}
...
### Collections: organising your experiments {#collections}
