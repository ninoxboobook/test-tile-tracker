...
import { createCone } from '../actions'

export default function NewConePage() {
  return (
    <PageLayout title="New Cone">
      <form action={createCone} className="space-y-8 divide-y divide-clay-200">
