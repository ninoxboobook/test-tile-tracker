...
import { createDecorationType } from '../actions'

export default function NewDecorationTypePage() {
  return (
    <PageLayout title="New Decoration Type">
      <form action={createDecorationType} className="space-y-8 divide-y divide-clay-200">
