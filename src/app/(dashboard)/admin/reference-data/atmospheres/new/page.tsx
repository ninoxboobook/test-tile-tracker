...
import { createAtmosphere } from '../actions'

export default function NewAtmospherePage() {
  return (
    <PageLayout title="New Atmosphere">
      <form action={createAtmosphere} className="space-y-8 divide-y divide-clay-200">
